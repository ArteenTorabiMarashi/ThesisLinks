...
interestingGenes <- unique(pop_gen_CVU_genes$GeneId)
...
write.table(results.table.p, file = "/Users/arteen/Desktop/School/Thesis_Writing/Figures_and_Tables/GOTABLE_CVU_popGen.txt",
