...
interestingGenes <- unique(pop_gen_CVD_genes$GeneId)
...
# It cant read exponents
final_table <- rbind(results.table.bh, all_table_final[4209,], results.table.p)

write.table(final_table, file = "/Users/arteen/Desktop/School/Thesis_Writing/Figures_and_Tables/GOTABLE_DVC_popGen.txt",
